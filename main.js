...
/* harmony import */ var _components_voice_search_model_voice_search_model_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/voice-search-model/voice-search-model.component */ "./src/app/components/voice-search-model/voice-search-model.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_voice_search_model_voice_search_model_component__WEBPACK_IMPORTED_MODULE_17__["VoiceSearchModelComponent"],
            ],
            imports: [
            ...
            entryComponents: [_components_popup_model_popup_model_component__WEBPACK_IMPORTED_MODULE_12__["PopupModelComponent"], _components_delete_delete_component__WEBPACK_IMPORTED_MODULE_13__["DeleteComponent"], _components_voice_search_model_voice_search_model_component__WEBPACK_IMPORTED_MODULE_17__["VoiceSearchModelComponent"]],
...
/* harmony import */ var _voice_search_model_voice_search_model_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../voice-search-model/voice-search-model.component */ "./src/app/components/voice-search-model/voice-search-model.component.ts");
/* harmony import */ var _popup_model_popup_model_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../popup-model/popup-model.component */ "./src/app/components/popup-model/popup-model.component.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_http_http_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/http/http.service */ "./src/app/services/http/http.service.ts");
/* harmony import */ var _services_app_app_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../services/app/app.service */ "./src/app/services/app/app.service.ts");
...
var TopBarComponent = /** @class */ (function () {
    ...
    TopBarComponent.prototype.openAddModel = function () {
        var config = new _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"]();
        config.height = '600px';
        config.width = '330px';
        var dialogRef = this.dialog.open(_popup_model_popup_model_component__WEBPACK_IMPORTED_MODULE_1__["PopupModelComponent"], config);
    };
    TopBarComponent.prototype.openVoiceSearchModel = function () {
        var _this = this;
        var config = new _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogConfig"]();
        config.height = '200px';
        config.width = '250px';
        var dialogRef = this.dialog.open(_voice_search_model_voice_search_model_component__WEBPACK_IMPORTED_MODULE_0__["VoiceSearchModelComponent"], config).afterClosed().subscribe(function (res) {
            if (res) {
                _this.searchText = res;
                _this.searchMovie();
            }
        });
    };
    TopBarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_http_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"], _services_app_app_service__WEBPACK_IMPORTED_MODULE_4__["AppService"],
...
/***/ "./src/app/components/voice-search-model/voice-search-model.component.css":
/*!********************************************************************************!*\
  !*** ./src/app/components/voice-search-model/voice-search-model.component.css ***!
  \********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/voice-search-model/voice-search-model.component.html":
/*!*********************************************************************************!*\
  !*** ./src/app/components/voice-search-model/voice-search-model.component.html ***!
  \*********************************************************************************/
/*! no static exports found */
...
module.exports = "\n\n<div class=\"main\">\n  <span class=\"close\" (click)=\"closeModel()\" aria-hidden=\"true\">&times;</span>\n<img src=\"../../../assets/images/microphone-512.png\"/>\n<p class=\"DefualtSpeak\" *ngIf=\"showDefualtSpeak\">Start Speak..</p>\n<p class=\"searchText\">{{searchText}}</p>\n</div>\n"

/***/ }),

/***/ "./src/app/components/voice-search-model/voice-search-model.component.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/components/voice-search-model/voice-search-model.component.ts ***!
  \*******************************************************************************/
/*! exports provided: VoiceSearchModelComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VoiceSearchModelComponent", function() { return VoiceSearchModelComponent; });
...
var VoiceSearchModelComponent = /** @class */ (function () {
    function VoiceSearchModelComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.showDefualtSpeak = true;
        this.searchText = "";
        dialogRef.disableClose = true;
    }
    VoiceSearchModelComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    VoiceSearchModelComponent.prototype.stopRecord = function () {
        this.recognition.stop();
        this.dialogRef.close(this.searchText);
    };
    VoiceSearchModelComponent.prototype.closeModel = function () {
        this.dialogRef.close();
    };
    VoiceSearchModelComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-voice-search-model',
            template: __webpack_require__(/*! ./voice-search-model.component.html */ "./src/app/components/voice-search-model/voice-search-model.component.html"),
            styles: [__webpack_require__(/*! ./voice-search-model.component.css */ "./src/app/components/voice-search-model/voice-search-model.component.css")]
        }),
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"], Object])
    ], VoiceSearchModelComponent);
    return VoiceSearchModelComponent;
}());
